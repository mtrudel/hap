defmodule HAP.IIDTest do
  ...
  test "encodes & decodes service records properly" do
    assert HAP.IID.to_iid(123) |> HAP.IID.service_index() == 123
  end

  test "encodes service record 0 as iid 1" do
    assert HAP.IID.to_iid(123, 234) |> HAP.IID.service_index() == 123
    assert HAP.IID.to_iid(123, 234) |> HAP.IID.characteristic_index() == 234
  end
