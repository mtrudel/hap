defmodule HAP.PairSetupTest do
  ...
  test "A valid pair-setup flow results in a pairing being made" do
    ...
    {:ok, %HTTPoison.Response{body: body}} =
      HTTPoison.post(endpoint, HAP.TLVEncoder.to_binary(m1), "content-type": "application/pairing+tlv8")
    ...
    {:ok, %HTTPoison.Response{body: body}} =
      HTTPoison.post(endpoint, HAP.TLVEncoder.to_binary(m3), "content-type": "application/pairing+tlv8")
    ...
    {:ok, %HTTPoison.Response{body: body}} =
      HTTPoison.post(endpoint, HAP.TLVEncoder.to_binary(m5), "content-type": "application/pairing+tlv8")
